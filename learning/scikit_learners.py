...
from Maat.learning.string_kernel import *
...
def calculateMetrics(truth, predicted):
    ...
    try:
        ...
        metrics["specificity"] = specificity(truth, predicted) # From Aion.utils.misc
...
def trainAndTestEnsemble(X, y, Xtest=[], ytest=[], classifiers=[], selectKBest=0):
    """
...
def trainKFoldEnsemble(X, y, classifiers=[], K=10, kfold=10, selectKBest=0):
    """
...
def trainKFoldKNN(X, y, K=10, kfold=10, selectKBest=0):
    """
...
def trainAndTestKNN(X, y, Xtest=[], ytest=[], K=10, selectKBest=0):
    """
...
def trainAndTestKFoldKNN(X, y, Xtest, ytest, K=10, kfold=10, selectKBest=0):
    """
    Trains a K-NN using the training data and tests it using the test data using K-fold cross validation
    :type X: list
    :param y: The labels corresponding to the training feature vectors
...
def trainKFoldSVMSSK(X, y, kfold=10, subseqLength=3, selectKBest=0):
...
def trainAndTestKFoldSVMSSK(X, y, Xtest, ytest, kfold=10, subseqLength=3, selectKBest=0):
    """
...
def trainKFoldSVM(X, y, C=1, selectKBest=0, kfold=10):
    """
...
def trainAndTestSVM(X, y, Xtest=[], ytest=[], C=1, selectKBest=0):
    """
...
def trainAndTestKFoldSVM(X, y, Xtest, ytest, C=1, selectKBest=0, kfold=10):
    """
    Trains a SVM using the training data and tests it using the test data using K-fold cross validation
    :param X: The matrix of training feature vectors
    :type X: list
...
def trainKFoldRandomForest(X, y, estimators=10, criterion="gini", maxdepth=None, selectKBest=0, kfold=10):
    """
...
def trainAndTestRandomForest(X, y, Xtest=[], ytest=[], estimators=10, criterion="gini", maxdepth=None, selectKBest=0):
    """
...
def trainAndTestKFoldRandomForest(X, y, Xtest, ytest, estimators=10, criterion="gini", maxdepth=None, selectKBest=0, kfold=10):
    """
    Trains a tree using the training data and tests it using the test data using K-fold cross validation
    :param Xtr: The matrix of training feature vectors
    :type Xtr: list
